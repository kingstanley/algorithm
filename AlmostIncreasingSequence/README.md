Given a sequence of integers as array, determine whether its possible to obtain strictly increasing sequence by removing no more than one element from the array.
